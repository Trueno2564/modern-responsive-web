    ...
    return (
        <div id='overview' className='p-5 mt-3 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-400 md:px-24 md:py-52'>
            <div className='items-center md:grid md:grid-cols-2'>
                <div>
                    <h1 className='text-4xl font-bold text-white md:leading-snug md:text-6xl'>Desarrolla tus habilidades <br/> para el futuro</h1>
                    <p className='mt-5 text-white'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae voluptatem reprehenderit aperiam illo et commodi ad provident nobis, dolorem nisi consequatur sed impedit suscipit quidem facilis, ipsum iste optio! Iure?
                    </p>
                    ...
                    <div>
                        ...
                        <button className='px-8 py-3 mr-10 text-white border-2 rounded-xl'>Tengo un cupon</button>
                    </div>
                </div>
                <div>
